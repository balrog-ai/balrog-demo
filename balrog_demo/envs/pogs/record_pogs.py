...
from balrog_demo.envs.pogs.pogs_params import add_extra_params_pogs_env, pogs_override_defaults
from balrog_demo.play import play


def parse_pogs_args(argv=None):
    parser, partial_cfg = parse_args(argv=argv)
    add_extra_params_pogs_env(parser)
    add_extra_params_demo(parser)
    pogs_override_defaults(partial_cfg, parser)
